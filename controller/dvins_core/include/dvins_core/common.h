...
#ifndef GAZEBO_PLUGINS_COMMON_H_
#define GAZEBO_PLUGINS_COMMON_H_
...
bool getSdfParam(sdf::ElementPtr sdf, const std::string& name, T& param, const T& default_value, const bool& verbose =
  ...
  if (sdf->HasElement(name)) {
    ...
    param = default_value;
    if (verbose)
      gzerr << "[gazebo_plugins] Please specify a value for parameter \"" << name << "\".\n";
  }
  return false;
}
...
#endif /* GAZEBO_PLUGINS_COMMON_H_ */
